...
''' 
Fine-tunes the vanilla urduhack/roberta-urdu-small model from huggingface
...
May be run on condor by submitting condor_roberta_urdu_imb_train.cmd
'''
...
model = AutoModelForSequenceClassification.from_pretrained("urduhack/roberta-urdu-small", num_labels=7)
...
train_file = "../data/urdu/train/train_cleaned.tsv"
train_data = pd.read_table(train_file, header=0)
dev_file = "../data/urdu/dev/urdu_dev_new.tsv"
...
training_args = TrainingArguments(
    output_dir="roberta_urdu_imb_output",
    learning_rate=2e-5,
...
#save model
pt_save_directory = "/home2/esokada/LING573/573_affect_recognition/src/roberta_urdu_imb_model"
